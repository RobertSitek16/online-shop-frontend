...
export class AdminReviewComponent implements OnInit {
  ...
  confirmModerate(element: AdminReview) {
    this.dialogService.openConfirmDialog("Do you really want to accept this review?")
      .afterClosed()
      .subscribe(result => {
        if (result) {
  ...
  confirmDelete(element: AdminReview) {
    this.dialogService.openConfirmDialog("Do you really want to delete this review?")
      .afterClosed()
      .subscribe(result => {
        if (result) {
