...
export class LostPasswordComponent implements OnInit {
      ...
      this.loginService.lostPassword(this.formGroup.value)
        .subscribe({
          next: result => {
            ...
            this.snackBar.open("An email with the link has just been sent.", "", { duration: 3000, panelClass: "snack-bar-bg-color-ok" });
          },
  ...
  private passwordIdentical(changePassword: any) {
    ...
    this.formChangePasswordError = "Passwords are not the same!";
    return false;
  }
